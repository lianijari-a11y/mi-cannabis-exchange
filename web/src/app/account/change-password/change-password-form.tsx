...
import { changePasswordAfterForceAction } from "./actions";

export function ChangePasswordForm() {
  const [state, formAction, pending] = useActionState(changePasswordAfterForceAction, undefined);
  ...
  return (
    <form action={formAction} className="space-y-3">
      ...
      >
        {pending ? "Setting password…" : "Set new password & continue"}
      </button>
    </form>
  );
}
